      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '52px 24px' }}>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <p style={{ fontSize: 16, color: '#4A3F38', fontWeight: 300 }}>
            {profile.role === 'student' && 'Browse open problems and start building.'}
            {profile.role === 'poster' && 'Manage your posted problems and review submissions.'}
            {profile.role === 'admin' && 'Manage the platform — approve problems, judge submissions.'}
          </p>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
          ...
          {profile.role === 'poster' && (
            <>
              <ActionCard href="/post-problem" icon="✏️" title="Post a Problem" desc="Submit a new problem for students to solve." />
              <ActionCard href="/problems" icon="📋" title="My Problems" desc="Track submissions on your posted problems." />
              <ActionCard href="/dashboard/judging" icon="⚖️" title="Judge Submissions" desc="Review and score student submissions." />
            </>
          )}
          {profile.role === 'admin' && (
            <>
