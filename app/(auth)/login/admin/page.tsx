        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <Link href="/" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, textDecoration: 'none', marginBottom: 24 }}>
            <svg width="34" height="34" viewBox="0 0 34 34" fill="none">
              <rect width="34" height="34" rx="8" fill="#1C1410"/>
        ...
        <div style={{ background: '#fff', border: '1.5px solid rgba(28,20,16,0.08)', borderRadius: 14, padding: '36px 40px', boxShadow: '0 4px 24px rgba(28,20,16,0.07)' }}>
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              ...
              <input
                type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="admin@sproutnet.org"
                ...
                onFocus={e => e.target.style.borderColor = '#1C1410'} onBlur={e => e.target.style.borderColor = 'rgba(28,20,16,0.12)'}
              />
            </div>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              background: loading ? '#4A3F38' : '#1C1410', border: 'none', borderRadius: 8,
          ...
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, color: '#9CA3A0', textAlign: 'center' }}>
            <Link href="/login" style={{ color: '#2D6A4F', fontWeight: 600, textDecoration: 'none' }}>Back to role selection</Link>
          </p>
        </div>
