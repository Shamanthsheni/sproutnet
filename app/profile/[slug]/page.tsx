        ...
        <div style={{
          ...
          <aside style={{
            ...
            {[
              ...
              { label: 'Milestones Done', value: userProfile.milestones_done ?? 0, accent: '#2D6A4F' },
            ].map((item, index) => (
          ...
          <section style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: 13, color: '#7A7068' }}>
                {submissions.length} recent item{submissions.length === 1 ? '' : 's'}
              </div>
            </div>
            ...
            {submissions.length === 0 ? (
              <div style={{
                ...
                <div style={{ fontSize: 14, color: '#7A7068' }}>
                  {isOwnProfile
                    ? 'Start solving a problem and your work will begin showing up here.'
                    : 'This builder has not published any submission activity yet.'}
                </div>
              </div>
            ) : (
                    ...
                    <div style={{
                      ...
                      <div>
                        <div style={{
                          ...
                          {submission.problems?.title ?? 'Problem submission'}
                        </div>
                        <div style={{ fontSize: 13, color: '#7A7068' }}>
                          {(submission.problems?.domain ?? 'Unknown domain')} · Milestone {submission.milestone}
                        </div>
                      </div>
                      ...
                      <span style={{
                        fontFamily: 'JetBrains Mono, monospace',
                        fontSize: 11,
                        color: submission.status === 'pending' ? '#1E40AF' : '#2D6A4F',
                        background: submission.status === 'pending' ? 'rgba(30,64,175,0.08)' : '#EAF4EE',
                        borderRadius: 999,
                        padding: '6px 10px',
                        textTransform: 'uppercase',
                        letterSpacing: '0.08em',
                      }}>
                        {submission.stage} · {submission.status}
                      </span>
                    </div>
